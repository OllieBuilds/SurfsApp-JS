...
/***/ function(module, exports, __webpack_require__) {
	...
	$('#add_board_to_session').on('submit', function (event) {
	  ...
	  var data = getFormFields(this);
	  console.log(data);
	  var sessionId = parseInt(data.session.id);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showQuiver = function showQuiver() {
	  $.ajax({
	    method: 'GET',
	    url: app.api + 'surfboards',
	    headers: {
	    ...
	    var quivTem = __webpack_require__(29);
	    $('#show-quiver-sesh').append(quivTem({ surfboards: data }));
	    displayQuiver(data);
	    console.log(data);
	  });
	...
	var addSession = function addSession(success, failure, data) {
	  $.ajax({
	    method: 'POST',
	...
	var deleteSession = function deleteSession(success, failure, id) {
	  $.ajax({
	    method: 'DELETE',
	...
	var showSessions = function showSessions() {
	  $.ajax({
	    method: 'GET',
	    url: app.api + 'sessions',
	    headers: {
	...
	var addBoardToSession = function addBoardToSession(success, failure, data) {
	  $.ajax({
	    method: 'PATCH',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sign_in_success = function sign_in_success(data) {
	  app.user1 = data.user;
	...
	var render_charts = function render_charts(data) {
	  console.log(data.length);
	  var count = 0;
	  var charts = data[count].charts.swell;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<li class=\"session_handles\">\n<strong id="
	    ...
	    + "\n<br>\nAt: "
	    + alias2(alias1((depth0 != null ? depth0.spot : depth0), depth0))
	    + "\n<br>\nConditions: "
	    + alias2(alias1((depth0 != null ? depth0.conditions : depth0), depth0))
	    + "\n<br>\nBoard: "
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.sessions : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <li class=\"quiver_handles\">\n    <strong>Board id: "
	    + alias2(alias1((depth0 != null ? depth0.id : depth0), depth0))
	    + "</strong>\n    <br>\n    Shape: "
	    + alias2(alias1((depth0 != null ? depth0.shape : depth0), depth0))
	    + "\n    <br>\n    Size: "
	    + alias2(alias1((depth0 != null ? depth0.height : depth0), depth0))
	    + "\"\n    <br>\n    Fin Setup: "
	    + alias2(alias1((depth0 != null ? depth0.fin_setup : depth0), depth0))
	    + "\n    <hr>\n  </li>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.surfboards : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <!-- "
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.surfboards : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + " -->\n";
	},"useData":true});
